...
def _urdf_generic_from_object(
    ...
    for subobj, subname in get_leafs_and_subnames(obj):
        ...
        if not placement:
            ...
            cumulative_plc = get_cumulative_placement_top_to_down(obj, subobj)
            cumulative_plc_without_subobj = cumulative_plc * subobj.Placement.inverse()
            this_placement = placement * cumulative_plc_without_subobj * placement_for_dae_export           
